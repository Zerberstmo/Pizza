...
| P2 | **Idee: versteckter Gutschein → verstecktes Warenkorb-Item mit Menge** — Code (z. B. `weed420`) schaltet ein sonst unsichtbares, bestellbares Item frei, das mit **Anzahl** in den Warenkorb kommt. ❓ Klären: Preis, Sichtbarkeit in Admin-Bestellungen. Vorbedingung **erfüllt** (2026-07-16): Cart-Modell kennt jetzt Mengen (`quantity`, Stepper, Preis × Menge). Eigenes Design. | offen (Ideenstatus) | Mengen im Warenkorb |
