...
| P2 | **Sonderartikel: Sofort-Bestellung + Sofort-WhatsApp** — reine Special-Bestellung ohne Abhol-Beschränkungen (Datum/Zeit = jetzt), sofortige WhatsApp an den Betreiber via DB-Trigger/`pg_net` + Cron-Sicherheitsnetz. Design **freigegeben**, Umsetzung offen: `docs/superpowers/specs/2026-07-17-sonderartikel-sofortbestellung-design.md` | offen | Sonderartikel/VIP |
