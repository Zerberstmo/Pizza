...
| P1 | Teil-B: Supabase-Schema, echte Admin-Auth, WhatsApp via CallMeBot, Bestell-Status + Realtime, serverseitige Vorlauf-/Preis-Validierung, Telefon-Validierung | offen | Teil-A |
